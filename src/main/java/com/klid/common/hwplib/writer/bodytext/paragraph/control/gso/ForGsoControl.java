...
import com.klid.common.hwplib.writer.bodytext.paragraph.control.gso.part.shapecomponent.ForShapeComponentForContainer;
import com.klid.common.hwplib.writer.bodytext.paragraph.control.gso.part.shapecomponent.ForShapeComponentForNormal;
...
public class ForGsoControl {
	 ...
	 * @throws IOException
	 */
	public static void write(GsoControl gso, StreamWriter sw) throws IOException {
