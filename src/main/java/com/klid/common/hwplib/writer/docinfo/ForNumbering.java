...
public class ForNumbering {
	 ...
	 * @throws Exception
	 */
	public static void write(Numbering n, StreamWriter sw) throws IllegalArgumentException, IOException {
		recordHeader(n, sw);
	 ...
	 */
	private static int getSize(Numbering n, FileVersion version) throws NumberFormatException {
		int size = 0;
