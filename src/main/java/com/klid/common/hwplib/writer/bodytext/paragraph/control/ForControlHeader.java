...
import com.klid.common.hwplib.object.bodytext.control.ctrlheader.CtrlHeaderHeader;
...
public class ForControlHeader {
	 ...
	 * @throws IOException
	 */
	public static void write(ControlHeader h, StreamWriter sw) throws IOException {
