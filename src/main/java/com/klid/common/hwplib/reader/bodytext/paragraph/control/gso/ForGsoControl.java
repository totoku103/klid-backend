...
public class ForGsoControl {
	 ...
	 * @throws IOException
	 */
	private Caption caption() throws IOException {
		sr.readRecordHeder();
	 ...
	 * @throws IOException
	 */
	private long gsoIDFromShapeComponent() throws IOException {
		if (sr.isImmediatelyAfterReadingHeader() == false) {
			sr.readRecordHeder();
		}
	 ...
	 * @throws IOException
	 */
	private void restPartOfControl() throws IOException {
	 ...
	 * @throws IOException
	 */
	public GsoControl readInContainer(StreamReader sr) throws IOException {
		this.sr = sr;
	 ...
	 * @throws IOException
	 */
	private void shapeComponentInContainer() throws IOException {
		sr.readRecordHeder();
		if (sr.getCurrentRecordHeader().getTagID() == HWPTag.SHAPE_COMPONENT) {
			long id = sr.readUInt4();
