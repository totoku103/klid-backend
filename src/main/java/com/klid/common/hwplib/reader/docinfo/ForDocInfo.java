...
import com.klid.common.hwplib.reader.ForUnknown;
...
public class ForDocInfo {
	 ...
	 * @throws IOException
	 */
	public void read(DocInfo di, StreamReader sr) throws IOException {
		this.sr = sr;
		this.docInfo = di;
	 ...
	 * @throws IOException
	 */
	private void recordBody() throws IOException {
	 ...
	 * @throws IOException
	 */
	private void addFaceNameByIDMappings(FaceName fn) throws IOException {
		...
		if (docInfo.getHangulFaceNameList().size() < idm
			...
			throw new IOException("Count of FaceName is greater than ID Mappings");
		}
	}
