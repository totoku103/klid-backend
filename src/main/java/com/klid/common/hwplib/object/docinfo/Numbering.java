...
public class Numbering {
	 ...
	 */
	public LevelNumbering getLevelNumbering(int level) throws IllegalArgumentException {
		if (level >= 1 && level <= 7) {
	 ...
	 *             (level <1 || level>7) 일떼 발샐한다.
	 */
	public long getStartNumberForLevel(int level) throws IllegalArgumentException {
		if (level >= 1 && level <= 7) {
