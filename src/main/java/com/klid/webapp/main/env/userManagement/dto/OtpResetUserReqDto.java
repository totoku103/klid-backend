...
public class OtpResetUserReqDto {
    private final UserManagementRequestTypes requestTypes = UserManagementRequestTypes.OTP_SECRET_KEY_RESET_REQUEST;
