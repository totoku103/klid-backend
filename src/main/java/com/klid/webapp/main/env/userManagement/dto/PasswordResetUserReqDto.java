...
public class PasswordResetUserReqDto {
    private final UserManagementRequestTypes requestTypes = UserManagementRequestTypes.PASSWORD_RESET_REQUEST;
    ...
    public String toString() {
        return "PasswordResetUserReqDto{" +
