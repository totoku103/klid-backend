...
public class AccountLockResetUserReqDto {
    private final UserManagementRequestTypes requestTypes = UserManagementRequestTypes.ACCOUNT_LOCK_RESET_REQUEST;
    ...
    public String toString() {
        return "AccountLockResetUserReqDto{" +
