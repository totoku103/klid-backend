...
public class AddUserReqDto {
    ...
    private final UserManagementRequestTypes requestTypes = UserManagementRequestTypes.REGISTRATION_REQUEST;
...
//        기본 정보
        ...
        if (StringUtils.isBlank(info.getUserPwd())) throw new CustomException("비밀번호를 입력하세요.");
