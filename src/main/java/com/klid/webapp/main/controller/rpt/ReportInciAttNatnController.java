...
//		hmlMaker.setParam("report_title", (String)reqMap.get("sTitle"));
		...
		ArrayList<LinkedHashMap<String, Integer>> typeGrid = (ArrayList) reqMap.get("attGrid");
		hmlMaker.insertTableRow("tb1", "row1",typeGrid.size());

		hmlMaker.setParam("report_title", "공격국가");
		hmlMaker.setParam("titleName","공격국가");
		hmlMaker.setParam("title","공격국가");
		hmlMaker.setParam("title2","공격국가");
...
//		return service.exportReportAttNatn(new Criterion(reqMap));
	}
