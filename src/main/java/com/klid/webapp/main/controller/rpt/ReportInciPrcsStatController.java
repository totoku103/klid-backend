...
public class ReportInciPrcsStatController {
	...
	public ReturnData getPrcsStatList(@RequestParam Map<String, Object> reqMap) {
	...
	public ReturnData exportReportInciPrcsStat(@RequestBody Map<String, Object> reqMap, HttpServletResponse response) {
