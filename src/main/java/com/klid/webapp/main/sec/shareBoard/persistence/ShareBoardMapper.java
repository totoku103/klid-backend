 ...
 */
package com.klid.webapp.main.sec.shareBoard.persistence;
...
public interface ShareBoardMapper {
	...
	/** 게시판 최근리스트 받아오기 */
	List<ShareBoardDto> getPostBoardList(Map<String, Object> paramMap);

	/** 타입으로 게시판 리스트 받아오기 */
	List<ShareBoardDto> getBoardList(Map<String, Object> paramMap);

	/** 게시판 번호로 컨텐츠 보기 */
	ShareBoardDto getBoardContents(Map<String, Object> paramMap);
	...
	List<ShareBoardDto> getShareBoardSidoCnt(Map<String, Object> paramMap);

	List<ShareBoardDto> getBoardDetail(Map<String, Object> param);
}
