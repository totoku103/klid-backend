...
public class NoticeBoardDto {
	...
	private String control;			//권한 -> 출처로 변경
	private String controlStr;		//출처 코드값
	...
	private String surveyTypeCode;	//공지 설문 타입 구분값
	private String surveyExamType;	//공지 설문 문항 타입 text: 입력, choose: 객관식 선택
	private String answerName;		//설문 객관식 응답명
	private int answerCnt;			//설문 응답수
	private String surveyAnswer;	//주관식 응답값
	...
	public String getSurveyExamType() {
		return surveyExamType;
	}
	public void setSurveyExamType(String surveyExamType) {
		this.surveyExamType = surveyExamType;
	}
