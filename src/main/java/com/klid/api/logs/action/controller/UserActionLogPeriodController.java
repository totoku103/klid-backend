...
import com.klid.api.logs.action.dto.PeriodSearchReqDTO;
import com.klid.api.logs.action.dto.UserActionLogPeriodResDTO;
import com.klid.api.logs.action.service.UserActionLogPeriodService;
...
@RequestMapping("/api/logs/user-action/period")
public class UserActionLogPeriodController {

    private final UserActionLogPeriodService userActionLogPeriodService;
    ...
    public ResponseEntity<?> getData(@RequestBody final PeriodSearchReqDTO searchReqDTO) {
        ...
        final List<UserActionLogPeriodResDTO> data =
                userActionLogPeriodService.getData(searchReqDTO.getSystemType(), searchReqDTO.getStartYmd(), searchReqDTO.getEndYmd());
