...
import com.klid.api.logs.connect.dto.DailySearchReqDTO;
import com.klid.api.logs.connect.dto.UserConnectLogDailyResDTO;
import com.klid.api.logs.connect.service.UserConnectLogDailyService;
...
@RequestMapping("/api/logs/user-connect/daily")
public class UserConnectLogDailyController {

    private final UserConnectLogDailyService userConnectLogDailyService;
    ...
    public ResponseEntity<?> getData(@RequestBody final DailySearchReqDTO searchReqDTO) {
        ...
        final List<UserConnectLogDailyResDTO> data =
                userConnectLogDailyService.getData(searchReqDTO.getYyyyMMdd(), searchReqDTO.getSystemType());
