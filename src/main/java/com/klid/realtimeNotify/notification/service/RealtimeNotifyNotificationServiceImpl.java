...
import com.klid.realtimeNotify.notification.dto.NotificationResponseDto;
...
public class RealtimeNotifyNotificationServiceImpl extends MsgService implements RealtimeNotifyNotificationService {
    ...
    public RealtimeNotifyNotificationServiceImpl(MessageSource messageSource, SimpMessagingTemplate messagingTemplate) {
        super(messageSource);
