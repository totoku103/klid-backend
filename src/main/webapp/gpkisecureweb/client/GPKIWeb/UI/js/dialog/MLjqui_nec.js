...
(function(a) {
    ...
    a.extend(a.MLjqui._MLjquiWindow.prototype, {
        ...
        focus: function() {
            ...
            } catch (e) {console.log("UI Exception");}
        },
        _makeModal: function() {
        ...
        _removeEventHandlers: function() {
            ...
            this.removeHandler(this.host, "keyup");
        ...
        _addDragDropHandlers: function() {
            if (this.draggable) {
                ...
                } catch (f) {console.log("UI Exception");}
            }
        },
