...
define(function (require) {
    var d3 = require('d3'),
        ...
        countryHTML = require('text!./Extctrl_countryHTML.jsp');

    function Extctrl_countryController(id) {
        this.id = id || 'extctrl_country';
    }

    Extctrl_countryController.prototype = {
        getHTML: function () {
    ...
    return Extctrl_countryController;
});
