...
<div class="TypeGrid">
    <div style="width:100%; height:300px; position:absolute;top:130px; ">
     <%--   <div class="TypeGridPanel"  id="#id_typeChart"  style="width:100%;height:400px;position:absolute;top:60px; border:1px solid #bdbdbd; " ></div>--%>
       <div class="TypeGridPanel"  id="#id_typeChart"  style="width:100%;height:100%;"></div>
    </div>
</div>