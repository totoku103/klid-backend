...
var Main = {
		...
		initDesign: function() {
			...
			HmGrid.create($grid, {
				source: new $.jqx.dataAdapter(
						{
							datatype: 'json',
                            url: ctxPath + '/api/main/home/forgeryUrl/getForgeryUrl',
                ...
                columns:
                    [
                        ...
                        { text : '장애여부', datafield     : 'lastRes', width : '10%', editable: false, cellsalign: 'center',
                            cellsrenderer: function(row, column, value, rowData) {
                                var delYn = '장애';
                                if(value != 4 && value != 5){
                                    delYn = '정상';
                        ...
                        { text : 'DEPTH', datafield : 'depth', width : '10%', editable: false, cellsalign: 'center'},
                        ...
                        { text : '예외여부', datafield : 'excpYn', width : '10%', cellsalign: 'center',
                            cellsrenderer: function(row, column, value, rowData) {
                                var excpYn = '아니오';
                                if(value == 'Y'){
                                    excpYn = '예';
		...
		search : function() {
			HmGrid.updateBoundData($grid, ctxPath + '/api/main/home/forgeryUrl/getForgeryUrl');
		},
