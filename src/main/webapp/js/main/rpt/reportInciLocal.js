...
var Main = {
    ...
    initDesign: function() {
        ...
        HmGrid.create($localGrid, {
            source: new $.jqx.dataAdapter(
                {
                    datatype: 'json',
                    url: $('#ctxPath').val() + '/api/main/rpt/reportInciLocal/getLocalList'
                },
                {
    ...
    createChart: function(){
        ...
        Server.get('/api/main/rpt/reportInciLocal/getLocalList', {
            data: params,
    ...
    exportRpt: function() {
        ...
        var ch_params = {fname:fname,imgData:imgData,sType:"local"};
