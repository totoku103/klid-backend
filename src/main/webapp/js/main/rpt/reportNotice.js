...
var Main = {
    ...
    initDesign: function() {
        ...
        HmGrid.create($dataGrid, {
            source: new $.jqx.dataAdapter(
                {
                    datatype: 'json',
                    url: $('#ctxPath').val() + '/api/main/rpt/reportCollection/getNoticeListDetail',
            ...
            /*rendertoolbar: function(toolbar) {
                HmGrid.titlerenderer(toolbar, '공지사항');
            },*/
            columns:
                [
    ...
    exportRpt: function() {
        ...
        HmUtil.exportExcel(ctxPath + '/api/main/rpt/reportCollection/exportNoticeList', params);
    }
