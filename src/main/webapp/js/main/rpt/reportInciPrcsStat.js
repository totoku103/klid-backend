var $prcsStatGrid, $dateType, $date1, $date2, $rptChart, $time;
...
var Main = {
    ...
    initVariable: function() {
        $rptChart = $('#rptChart'), $prcsStatGrid = $('#prcsStatGrid');
    ...
    initDesign: function() {
        ...
        // 우측 그리드
        HmGrid.create($prcsStatGrid, {
            source: new $.jqx.dataAdapter(
                {
                    datatype: 'json',
                    url: $('#ctxPath').val() + '/api/main/rpt/reportInciPrcsStat/getPrcsStatList'
                },
                {
            ...
            columns:
                [
                    { text: '사고처리상태', datafield: 'name', cellsalign: 'center', width: '60%' },
    ...
    search: function() {
        ...
        HmGrid.updateBoundData($prcsStatGrid);
        Main.createChart();
    },
    ...
    createChart: function(){
        ...
        Server.get('/api/main/rpt/reportInciPrcsStat/getPrcsStatList', {
            data: params,
    ...
    exportRpt: function() {
        ...
        var hwpParams = {
            prcsStatGrid:$prcsStatGrid.jqxGrid('source').originaldata
        };
        ...
        Server.post('/api/main/rpt/reportInciPrcsStat/saveHighChartImg', {
            data: ch_params,
            success: function(result) {
                $.extend(hwpParams, ch_params);
                HmUtil.exportHwp(ctxPath + '/api/main/rpt/reportInciPrcsStat/exportReportInciPrcsStat', hwpParams);
            }
        });
