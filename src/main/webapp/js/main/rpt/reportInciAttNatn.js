var $attGrid, $dateType, $date1, $date2, $rptChart, $time;
...
var Main = {
    ...
    initVariable: function() {
        $rptChart = $('#rptChart'), $attGrid = $('#attGrid');
        $dateType = $('#dateType'),
    ...
    initDesign: function() {
        ...
        $("#topSize").jqxDropDownList({ width: 60, height: 21, theme: jqxTheme, autoDropDownHeight: true,
            displayMember: 'label', valueMember: 'value', selectedIndex: 0,
            source: [
                { label: '5', value: '5' },
                { label: '10', value: '10' },
        ...
        // 우측 그리드
        HmGrid.create($attGrid, {
            source: new $.jqx.dataAdapter(
                {
                    datatype: 'json',
                    url: $('#ctxPath').val() + '/api/main/rpt/reportInciAttNatn/getAttList'
                },
                {
            ...
            columns:
                [
                    { text: '공격국가', datafield: 'name', cellsalign: 'center', width: '60%' },
    ...
    search: function() {
        ...
        HmGrid.updateBoundData($attGrid);
        Main.createChart();
    },
    ...
    createChart: function(){
        ...
        Server.get('/api/main/rpt/reportInciAttNatn/getAttList', {
            data: params,
    ...
    exportRpt: function() {
        ...
        var hwpParams = {
            attGrid:$attGrid.jqxGrid('source').originaldata
        };
        ...
        Server.post('/api/main/rpt/reportInciAttNatn/saveHighChartImg', {
            data: ch_params,
            success: function(result) {
                $.extend(hwpParams, ch_params);
                HmUtil.exportHwp(ctxPath + '/api/main/rpt/reportInciAttNatn/exportReportAttNatn', hwpParams);
            }
        });
    }
