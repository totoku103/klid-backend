var $prtyGrid, $dateType, $date1, $date2, $rptChart, $time;
...
var Main = {
    ...
    initVariable: function() {
        $rptChart = $('#rptChart'), $prtyGrid = $('#prtyGrid');
        $dateType = $('#dateType'),
    ...
    initDesign: function() {
        ...
        // 우측 - 이벤트
        HmGrid.create($prtyGrid, {
            source: new $.jqx.dataAdapter(
                {
                    datatype: 'json',
                    url: $('#ctxPath').val() + '/api/main/rpt/reportInciPrty/getPrtyList'
                },
                {
            ...
            columns:
                [
                    { text: '우선순위', datafield: 'name', cellsalign: 'center', width: '60%' },
    ...
    search: function() {
        ...
        HmGrid.updateBoundData($prtyGrid);
        Main.createChart();
    },
    ...
    createChart: function(){
        ...
        Server.get('/api/main/rpt/reportInciPrty/getPrtyList', {
            data: params,
    ...
    exportRpt: function() {
        ...
        var hwpParams = {
            prtyGrid:$prtyGrid.jqxGrid('source').originaldata
        };
        ...
        Server.post('/api/main/rpt/reportInciPrty/saveHighChartImg', {
            data: ch_params,
            success: function(result) {
                $.extend(hwpParams, ch_params);
                HmUtil.exportHwp(ctxPath + '/api/main/rpt/reportInciPrty/exportReportInciPrty', hwpParams);
            }
        });
    }
