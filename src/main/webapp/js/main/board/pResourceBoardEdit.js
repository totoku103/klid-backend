    ...
    $.ajax({
        ...
        success: function (jsonData) {
            if(jsonData.resultData == 'N'){
                ...
                Server.post('/api/main/sec/resourceBoard/editBoard', { data : /* $('#writeForm').serializeObject(), */
                    ...
                    success : function(result) {
                        ...
                        if ($('.jqx-file-upload-file-row').length == 0) {
                            location.href = $('#ctxPath').val() + '/main/board/pResourceBoardContents.do?boardNo=' + result.boardNo;
                        } else {
                            try {
