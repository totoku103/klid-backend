...
var Main = {
    ...
    initDesign : function() {
        ...
        $.ajax({
            type: "post",
            url: $('#ctxPath').val() + '/api/main/sec/resourceBoard/getMoisBoardContents',
        ...
        $.ajax({
            ...
            success : function(jsonData) {
                ...
                if(jsonData.resultData == 'N'){
                    ...
                    window.location.href = $('#ctxPath').val() + "/main/board/pMoisBoardEdit.do?boardNo=" + $('#boardNo').val();
                }
            }
        });
    },
        ...
        $.ajax({
            ...
            success: function (jsonData) {
                if(jsonData.resultData == 'N'){
                    ...
                    $.ajax({ type : "post", url : $('#ctxPath').val() + '/api/main/sec/resourceBoard/delMoisBoard', data : "boardNo=" + $('#boardNo').val(), dataType : "json", success : function(jsonData) {
                    } });
