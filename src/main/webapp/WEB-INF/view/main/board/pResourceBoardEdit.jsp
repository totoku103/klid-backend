...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/main/board/pResourceBoardEdit.js"></script>
	...
	<div class="p_contentsP10 ">
		<table style="border: 1px solid #989898;">
			...
			<tr class="pop_grid">
				...
				<td colspan="3"><input id="" class=" p_non_border" readonly="readonly"></td>
