...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/main/board/pMoisBoardContents.js"></script>
<form name="form">
    ...
    <div class="p_contentsP10 ">
        ...
        <div class="p_contentsM10 borderLine">
            <textarea id="editor" name="boardContent" class="boardContent2" style="border: none; width: 98%; height: 500px;"></textarea>
        </div>
    </div>
    <div class="p_btnPos ">
