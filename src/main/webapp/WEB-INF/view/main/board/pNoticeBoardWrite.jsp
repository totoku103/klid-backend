...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/main/board/pNoticeBoardWrite.js"></script>
		...
		<div class="p_contentsP10 ">
			<table style="border: 1px solid #989898;">
				...
				<tr class="pop_grid">
					...
					<td class="pop_gridSub">설문유형</td>
					<td>
						<div id="surveyType" name="surveyType" class="pop_combo1"></div>
					</td>
				</tr>
			</table>			
		</div>
