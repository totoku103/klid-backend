...
<form id="userAddForm" name="userAddForm" action="" style="margin-bottom: 0px;">
    ...
    <table style="border: 1px solid #989898;">
        ...
        <tr class="pop_grid">
            ...
            <td>
                <input type="text" name="userId" id="userId" style="width: 70%; margin-top: 2px;"
    ...
    <table style="border : 1px solid #989898;">
        ...
        <tr class="pop_grid">
            ...
            <td style="text-align:initial;">
                ...
                -
                <input type="text" id="offcTelNo2" class="pop_inputWrite4" style="width: 40px;" maxlength="4"
                       onkeyup="this.value=this.value.replace(/[^0-9]/g,'')">
                -
                <input type="text" id="offcTelNo3" class="pop_inputWrite4" style="width: 40px;" maxlength="4"
                       onkeyup="this.value=this.value.replace(/[^0-9]/g,'')">
            </td>
        </tr>
...
<script>
    ...
    function checkCommUserRequestStandBy(userId) {
        const url = "/main/env/user-management/history/check/user-id/" + userId + ".do";
        return fetch(url, {
            method: 'GET',
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.resultData > 0) {
                    ...
                    checkCommUserRequestStandBy(_data.userId)
                        .then(result => {
                            if (result.isAvailableId) {
                                duplicateYn = 'N';
                                alert("사용가능한 아이디입니다.")
                            }
                        })
    ...
    function userAdd() {
        ...
        const url = "/main/env/user-management/request/register.do"
        fetch(url, {
            method: 'POST',
            headers: {
