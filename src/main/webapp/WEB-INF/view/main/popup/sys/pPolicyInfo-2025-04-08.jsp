        ...
        <div class="image-box-container">
            ...
            <div class="image-box">
                ...
                <div class="hover-tooltip tooltip-position-left">
                    ...
                    <div class="tooltip-content">
                        <p>처리부서 : 디지털보안정책과,<br/>044-205-2746</p>
                    </div>
                </div>
            </div>
            <div class="tail-text">
            ...
            <div class="article-content">
                ...
                <ol id="history-policy-list">
                    <li class="none-list-style-type">
                        ...
                        <a id="compare-policy-tag" style="font-weight: bold; cursor: pointer;">&lt; 신·구 대조표 &gt;</a>
                    </li>
                    <li class="none-list-style-type">
...
<script>
    (function () {
        function onComparePolicyClickEvent(event) {
            ...
            const url = ctxPath + '/main/popup/compare-privacy-policy.do'
            $.post(url,
                (result) => {
                    const innerHtml = event.target.innerHTML.replaceAll('\(클릭\)', '').trim();
                    const offset = $('#pInfoWindow').offset();
                    $('#privacy-policy-modal').jqxWindow({
                        title: '<h1>' + innerHtml + '</h1>',
                        content: result,
                        position: 'center',
                        modalZIndex: 250,
                        width: 750,
                    ...
                    $('#privacy-policy-modal').jqxWindow('open')
                    resetModalCloseButtonStyle();
                });
        }
        ...
        function onHistoryPolicyClick(event) {
            ...
            $.post(ctxPath + '/main/popup/privacy-policy/' + elementId + '.do',
                (result) => {
                    const innerHtml = event.target.innerHTML.replaceAll('\(클릭\)', '').trim();
                    const offset = $('#pInfoWindow').offset();
                    $('#privacy-policy-modal').jqxWindow({
        ...
        function resetModalCloseButtonStyle() {
            document.querySelectorAll("div.jqx-window-close-button.jqx-icon-close").forEach(button => {
        ...
        function bindComparePolicyClickEvent() {
            document.getElementById('compare-policy-tag')
                .addEventListener('click', onComparePolicyClickEvent)
        }
