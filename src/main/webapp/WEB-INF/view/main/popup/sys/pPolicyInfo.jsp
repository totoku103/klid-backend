    ...
    <section>
        ...
        <div class="index-container">
            <ul class="index-list">
                ...
                <li class="index-item">
                    <a href="#index-17" title="제17조 자동화된 결정에 관한 사항">
                        <span>
                            제17조
                        </span>
                        <span>
                ...
                <li class="index-item">
                    <a href="#index-18" title="제18조 개인정보 보호(분야별)책임자의 성명 또는 개인정보 업무 담당부서 및 고충사항을 처리하는 부서에 관한 사항">
                        <span>
                            제18조
                        </span>
                        <span>
                            <img style="width: 40px;" src="/img/privacy-policy/2025-01/index/17.png" alt="제18조 개인정보 보호(분야별)책임자의 성명 또는 개인정보 업무 담당부서 및 고충사항을 처리하는 부서에 관한 사항"/>
                        </span>
                        <span>
                ...
                <li class="index-item">
                    <a href="#index-19" title="제19조 정보주체의 권익침해에 대한 구제방법">
                        <span>
                            제19조
                        </span>
                        <span>
                            <img src="/img/privacy-policy/2025-01/index/18.png" alt="제19조 정보주체의 권익침해에 대한 구제방법"/>
                        </span>
                        <span>
                            정보주체의 권익침해에 대한 구제방법
                        </span>
                ...
                <li class="index-item">
                    <a href="#index-20" title="제20조 개인정보 보호수준 평가 결과">
                        <span>
                            제20조
                        </span>
                        <span>
                            <img src="/img/privacy-policy/2025-01/index/19.png" alt="제20조 개인정보 보호수준 평가 결과"/>
                        </span>
                        <span>개인정보 보호수준 평가 결과</span>
                    </a>
                </li>
                <li class="index-item">
                    <a href="#index-21" title="제21조 고정형 영상정보처리기기 운영·관리에 관한 사항">
                        <span>
                            제21조
                        </span>
                        <span>
                            <img src="/img/privacy-policy/2025-01/index/20.png" alt="제21조 고정형 영상정보처리기기 운영·관리에 관한 사항"/>
                        </span>
                        <span>
                ...
                <li class="index-item">
                    <a href="#index-22" title="제22조 이동형 영상정보처리기기 운영·관리에 관한 사항">
                        <span>
                            제22조
                        </span>
                        <span>
                            <img src="/img/privacy-policy/2025-01/index/21.png" alt="제22조 이동형 영상정보처리기기 운영·관리에 관한 사항"/>
                        </span>
                        <span>
                ...
                <li class="index-item">
                    <a href="#index-23" title="제23조 그밖에 개인정보처리자가 개인정보처리 기준 및 보호조치 등에 관하여 자율적으로 개인정보 처리방침에 포함하여 정한 사항">
                        <span>
                            제23조
                        </span>
                        <span>
                ...
                <li class="index-item">
                    <a href="#index-24" title="제24조 개인정보 처리방침의 변경에 관한 사항">
                        <span>
                            제24조
                        </span>
                        <span>
                            <img src="/img/privacy-policy/2025-01/index/23.png" alt="제24조 개인정보 처리방침의 변경에 관한 사항"/>
                        </span>
                        <span>
    ...
    <section>
            ...
            <div class="article-content">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td rowspan="2" style="text-decoration: underline; color: blue; font-weight: bold;">필수 : 기관(시도,시군구), 부서, 직책, 이름, 이메일주소, 휴대폰번호, 사무실번호, 사용자ID(계정), 사용자 권한, 접속IP, 인터넷차단여부</td>
                        <td rowspan="2" style="text-decoration: underline; color: blue; font-weight: bold;">3년 (단, 회원탈퇴시 즉시 파기)</td>
                    </tr>
                    <tr>
                ...
                <div style="padding-left: 12px;">
                    <table class="plain-text-table">
                        ...
                        <tr>
                            <td>1. 관리적 조치:</td>
                            <td>
                                내부 관리계획 수립·시행, 정기적 직원 교육, 전담조직 운영
                            </td>
                        </tr>
                        <tr>
                            <td>2. 기술적 조치:</td>
                            <td>
                                개인정보처리시스템에 대한 등의 접근 권한의 관리, 접근통제시스템 설치 및 기타 관련 보호 조치, 인터넷망 차단 조치, 개인정보의 암호화, 접속기록의 보관 및
                                점검, 보안프로그램 설치 및 갱신, 개인정보처리시스템의 취약점 점검 및 보완
                            </td>
                        </tr>
                        <tr>
                            <td>3. 물리적 조치:</td>
                            <td>
                                전산실, 자료보관실 등의 접근통제, 서류·보조저장매체 등을 잠금장치가 있는 안전한 장소에 보관, 재해·재난에 대한 안전조치, 보조저장매체의 반출·입 통제
                            </td>
                        </tr>
                        </tbody>
                    </table>
        ...
        <div class="article" id="index-16">
            ...
            <div class="article-content">
                ...
                <p>
                    <span>② 권리 행사는 사이버안전부에 대해 「개인정보 보호법」 시행령 제41조 제1항에 따라 서면, 전화, 전자우편, 팩스(FAX), 인터넷 등을 통하여 하실 수 있으며, 사이버안전부는 이에 대해 지체없이 조치하겠습니다.</span>
                </p>
                <ol>
                    <li class="none-list-style-type">- 정보주체는 언제든지 홈페이지 ‘이름 &gt; 정보수정’에서 개인정보를 직접 조회・수정・삭제・처리정지・동의 철회하거나 ‘문의센터’를 통해 열람을 요청할 수 있습니다.</li>
        ...
        <div class="article" id="index-18">
            <div class="article-title">
                <span>제18조</span>
                <span>
                    <img style="width: 40px;" src="/img/privacy-policy/2025-01/contents/17.png" alt="제18조 개인정보 보호(분야별)책임자의 성명 또는 개인정보 업무 담당부서 및 고충사항을 처리하는 부서에 관한 사항"/>
                </span>
        ...
        <div class="article" id="index-19">
            <div class="article-title">
                <span>제19조</span>
                <span>
                    <img src="/img/privacy-policy/2025-01/contents/18.png" alt="제19조 정보주체의 권익침해에 대한 구제방법"/>
                </span>
        ...
        <div class="article" id="index-20">
            <div class="article-title">
                <span>제20조</span>
                <span>
                    <img src="/img/privacy-policy/2025-01/contents/19.png" alt="제20조 개인정보 보호수준 평가 결과"/>
                </span>
                <span>개인정보 보호수준 평가 결과</span>
            </div>
            <div class="article-content">
        ...
        <div class="article" id="index-21">
            <div class="article-title">
                <span>제21조</span>
                <span>
                    <img src="/img/privacy-policy/2025-01/contents/20.png" alt="제21조 고정형 영상정보처리기기 운영·관리에 관한 사항"/>
                </span>
        ...
        <div class="article" id="index-22">
            <div class="article-title">
                <span>제22조</span>
                <span>
                    <img src="/img/privacy-policy/2025-01/contents/21.png" alt="제22조 이동형 영상정보처리기기 운영·관리에 관한 사항"/>
                </span>
        ...
        <div class="article" id="index-24">
            <div class="article-title">
                <span>제24조</span>
                <span>
                    <img src="/img/privacy-policy/2025-01/contents/23.png" alt="제24조 개인정보 처리방침의 변경에 관한 사항"/>
                </span>
            ...
            <div class="article-content">
                ...
                <ol id="history-policy-list">
                    <li class="none-list-style-type">
                        <span id="2025-02" style="cursor: pointer;">2025. 2. 16 ~ 2025. 6. 30 적용지침 (클릭)</span>&nbsp;&nbsp;&nbsp;
                        <a id="compare-policy-tag-2025-02" style="font-weight: bold; cursor: pointer;">&lt; 신·구 대조표 &gt;</a>
                    </li>
                    <li class="none-list-style-type">
...
<script>
    (function () {
        function onComparePolicyClickEvent(event) {
            ...
            const popupOptions = "width=1240,height=800,top=10,left=10,resizable=no,scrollbars=no,menubar=no,toolbar=no,location=no,status=no";
        ...
        function onHistoryPolicyClick(event) {
            ...
            const popupOptions = "width=700,height=800,top=10,left=10,resizable=no,scrollbars=no,menubar=no,toolbar=no,location=no,status=no";
