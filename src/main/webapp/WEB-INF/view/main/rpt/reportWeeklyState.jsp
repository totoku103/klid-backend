...
<script src="${pageContext.request.contextPath}/js/main/rpt/reportWeeklyState.js"></script>
<body>
<div id="header">
                    ...
                    <div id="splitter">
                        <div>
                            <div id="splitterTop">
                                ...
                                <div>
                                    <!-- 유형별 사고내역 -->
                                    <div id="typeAccidentGrid_before" style="border: none;"></div>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div id="splitterSub">
                                <div>
                                    <!-- 주간사고처리 -->
                                    <div id="weeklyGrid" style=""></div>
                                </div>
                                <div>
                                    <!-- 사고처리누계 -->
                                    <div id="weeklyTotGrid" style=""></div>
                                </div>
                            </div>
                        </div>
                    </div>
