...
<script src="${pageContext.request.contextPath}/js/main/rpt/reportCtrsDailyState.js"></script>
<body>
<div id="header">
    ...
    <div id="layoutMain" >
        ...
        <div class="newBox">
            ...
            <div class="searchBox searchBox2">
                ...
                <%--</div>--%>
                <div>
                    <label style="float: left">경과일 : </label>
                    <div id="term_type_cd" class="pop_combo1" ></div>
                </div>
            </div>
            <div class="scontent" style="top: 100px;">
