...
<script src="${pageContext.request.contextPath}/js/main/rpt/reportInciPrty.js"></script>
<body>
<div id="header">
            ...
            <div class="scontent" style="top: 35px;">
                <div>
                    <div style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px">
                        <div id="bSplitter">
                            <div>
                                <div id="container" style="border-left: none; border-top: none; border-right: none; width: 100%; height: 100%;"></div>
                                <div id="container2" style="border-left: none; border-top: none; border-right: none; width: 300px; height: 300px; display:none;"></div>
                            </div>
                            <div>
                                <div id="prtyGrid" style="border: none"></div>
                            </div>
                        </div>
                    </div>
                </div>
