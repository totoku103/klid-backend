...
<script src="${pageContext.request.contextPath}/js/main/rpt/reportInciAttNatn.js"></script>
<body>
<div id="header">
        ...
        <div class="contentsP10" style="top: 0">
            <div class="searchBox">
                ...
                <div style="margin-left: 5px;">
                    <label style="float: left;">TOP_N: </label>
                    <div id="topSize" style="float: left" class="pop_combo1" ></div>
                </div>
                <div>
                ...
                <div>
                    <div style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px">
                        <div id="bSplitter">
                            ...
                            <div>
                                <div id="attGrid" style="border: none"></div>
                            </div>
                        </div>
                    </div>
                </div>
