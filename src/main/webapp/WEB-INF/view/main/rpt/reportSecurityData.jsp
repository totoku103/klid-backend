...
<script src="${pageContext.request.contextPath}/js/main/rpt/reportSecurityData.js"></script>
<body>
<div id="header">
        ...
        <div class="newBox">
            <div class="searchBox">
                <%--<div>--%>
                    ...
                    <%--&lt;%&ndash; <div id="cbPeriod" style="margin-left:0; margin-right:10px; float: left; " class="pop_combo1" ></div>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<div id="date1" style="float: left" class="pop_combo1" ></div>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<label style="float: left; padding-left:5px; padding-right:5px; padding-top:2px;">~</label>&ndash;%&gt;--%>
